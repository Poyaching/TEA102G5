...
public class Admin_listService {
	...
	public Admin_listService() {
		dao = new Admin_listDAO();
	}

	public Admin_listVO addAdmin_list(String admin_id, String admin_name, String admin_pwd, Integer admin_status) {
	...
	public Admin_listVO updateAdmin_list(String admin_id, String admin_name, String admin_pwd, Integer admin_status) {
