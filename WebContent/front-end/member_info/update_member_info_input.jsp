			...
			<FORM class="g-3" METHOD="post" ACTION="<%=request.getContextPath()%>/member_info/Member_info_frontServlet" name="form1" enctype="multipart/form-data">
				<div class="row">
					<div class="col-lg-2 col-sm-4 col-12">
						<div id="preview"><span class="text"><img id="output_image" src="<%=request.getContextPath()%>/member_info/Member_info_frontServlet?action=member_pic&member_id=${member_infoVO.member_id}"></span></div>
                        ...
                        <label for="file" class="form-control" style="cursor: pointer; width: 150px;">
                            	請上傳照片
                            <img src="<%=request.getContextPath()%>/front-end/member_info/images/2089052.png" alt="" width=16 height=16 style="margin-left: 10px; margin-top: -4px;">
                        </label>
                   ...
                   <div class="col-12 row">
           			...
           			<div class="col-12 row">
                         ...
                         <div class="col-6">
                             ...
                             <input type="text" id="goodfor"name="member_good_for" class="form-control"
                                     value="<%=member_infoVO.getMember_good_for()%>">
                         </div>
                         <div class="col-6">
                             <label for="about">關於我</label>
                             <textarea id ="about" class="form-control" name="member_about"><%=member_infoVO.getMember_about()%>
                             </textarea>
                         </div>
                     </div>
                     <div class="col-12 row">
					...
					<div class="col-12">
                        ...
                        <button id="submit-btn" type="submit" class="btn btn-primary col-4">確認更新</button>
                    </div>
				</div>
				</div>	
			</FORM>
