		...
		<ul>
			<c:forEach var="message" items="${error}">
				<li style="color: red"><b>${message}</b></li>
					...
					<li>
						<select id="selected"  style="width: 300px" onchange="show()">
				...
				<ul id="card">
					<li>信用卡卡號:      
				   		<input type=text name="pan_no1" size=4 value="" maxlength=4 onKeyUp="setBlur(this,'pan_no2');" style="margin-left:16px">-
					...
					<li> </li>
    				<li>卡片有校期限:   
    					<input type=text  name="period" value="MM" size=1>   
    					<input type=text  name="period1" value="YY" size=1>
    				</li>  
    				<li>信用卡安全碼:  
    					<input type=text size=3 name="Securityc">   
			...
			<ul>
				<li>姓名: <input type="text" name="name1">  聯絡信箱:<input type="text" name="email"></li>
