...
<body>
	...
	<%-- 錯誤表列 --%>
		...
		<div id="content">
			<FORM class="g-3" METHOD="post" ACTION="<%=request.getContextPath()%>/member_info/Member_infoServlet" name="form1" enctype="multipart/form-data">
				<div class="row">
					<div class="col-lg-2 col-sm-4 col-12">
<%-- 						<div id="preview"><span class="text"><img id="output_image" src="data:image;base64,<%=member_infoVO.getMember_pic2()%>"></span></div> --%>
