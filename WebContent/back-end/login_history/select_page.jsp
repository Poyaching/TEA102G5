...
<body bgcolor='white'>
	...
	<ul>
		<li><a href='listAllLogin_history.jsp'>列出全部登入歷史紀錄</a> <br>
		<br></li>


		<li>
			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/login_history/login_historyServlet">
				<b>輸入登入歷史紀錄編號 (如LOGIN00001):</b> <input type="text" name="login_id">
		...
		<li>
			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/login_history/login_historyServlet">
				<b>選擇登入歷史紀錄編號:</b> <select size="1" name="login_id">
	...
	<ul>
		<li><a href='<%=request.getContextPath()%>/back-end/login_history/addLogin_history.jsp'>新增登入歷史紀錄</a></li>
	</ul>
